...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/03/08 13:06:20 by susamani          #+#    #+#              #
#    Updated: 2024/06/18 12:20:00 by susamani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
	   ...
	   ft_strjoin.c ft_strtrim.c ft_putchar_fd.c  ft_striteri.c \
	   ft_strmapi.c ft_split.c ft_itoa.c ft_putstr_fd.c\
